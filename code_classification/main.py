import argparse
import TBCNN.classifier.tbcnn as tbcnn
import TreeCaps.classifier.treecaps as treecaps
...
if __name__ == '__main__':
    ...
    train_data, dev_data, test_data = getattr(dataloader, args.model_name+"Dataloader")()
    eval(args.model_name).train(args, train_data, dev_data, test_data)