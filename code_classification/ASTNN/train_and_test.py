...
if __name__ == '__main__':
    root = 'data/'
    train_data = pd.read_pickle(root+'train/sample_blocks.pkl')
    val_data = pd.read_pickle(root + 'dev/sample_blocks.pkl')
    test_data = pd.read_pickle(root+'test/sample_blocks.pkl')
