...
def train():
    ...
    parser.add_argument("--val_batch_size", type=int, default=16, help="number of batch_size of valid")
    ...
    parser.add_argument("--attn_heads", type=int, default=8, help="number of attention heads")  # 8
