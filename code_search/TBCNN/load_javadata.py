...
def read_train_data(datapath, codepath):
    ...
    return train_d, test_d, all_d,train, test
...
def get_batch(allnodes, allchildren, idx, batch_size, train_csv,data):
    ...
    for _, t in tmp:
        ...
        node1.append(nodes)
        ch1.append(children)
        docs1 = train_csv[data[idx+i]['id']][0]
        docs2 = train_csv[data[idx + i]['id']][2]
        doc1.append(docs1)
        doc2.append(docs2)
        i = i + 1
...
def get_testbatch(allnodes, allchildren, idx, batch_size, all_csv,data,trainlen):
    ...
    for _, t in tmp:
        ...
        node1.append(nodes)
        ch1.append(children)
        docs1 = all_csv[data[idx + i]['id']][0]
        docs2 = all_csv[data[idx + i]['id']][2]
