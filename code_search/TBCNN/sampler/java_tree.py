...
def main():
    ...
    parser.add_argument('--pairspath', type=str, default='/tbcnn-data/clonedata/javanew', help='')
    parser.add_argument('--filepath', default='/tbcnn-data/searchdata/', type=str, help='')
