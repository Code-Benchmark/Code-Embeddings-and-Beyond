...
class tbcnn_encoder(nn.Module):
    def __init__(self,feature_size,conv_feature, w_t, w_l, w_r, b_conv, w_h, b_h):
        super(tbcnn_encoder, self).__init__()
    ...
    def encode(self, nodes, children,parent):
    ...
    def forward(self, nodes, children,parent):

        y = self.encode(nodes,children,parent)
        return y
